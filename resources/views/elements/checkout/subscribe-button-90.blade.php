<button class="btn btn-round btn-outline-primary btn-block d-flex justify-content-between mt-2 mb-2 px-5 to-tooltip {{Auth::check() && !GenericHelper::isEmailEnforcedAndValidated() ? 'disabled' : ''}}"
        @if(Auth::check())
