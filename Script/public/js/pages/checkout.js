...
$(function () {
    ...
    $('#checkout-center').on('show.bs.modal', function (e) {
        ...
        if (type === 'tip' || type === 'chat-tip') {
            ...
            checkout.togglePaymentProviders(true, ['.nowpayments-payment-method', '.coinbase-payment-method', '.ccbill-payment-method', '.stripe-payment-method', '.paypal-payment-method']);
